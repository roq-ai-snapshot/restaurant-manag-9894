  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Manager - Streamlining Your Culinary Journey. Our SaaS software takes care of managing your restaurant, so you can focus on creating unforgettable dining experiences."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Manager - Streamlining Your Culinary Journey. Our SaaS software takes care of managing your restaurant, so you can focus on creating unforgettable dining experiences.`}
            </Text>
            <Box
