      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl
            ...
            alignItems="center"
            mb="4"
            isInvalid={!!formik.errors?.reservation_status}
          >
            <FormLabel htmlFor="switch-reservation_status">Reservation Status</FormLabel>
            <Switch
              id="switch-reservation_status"
              name="reservation_status"
              onChange={formik.handleChange}
              value={formik.values?.reservation_status ? 1 : 0}
            />
